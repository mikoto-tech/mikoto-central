...
public class UserController {
    ...
    public JSONObject registerUser(@NotNull HttpServletResponse response,
                                   @RequestParam @NotNull String reCaptchaResponse,
                                   @RequestParam @NotNull String userName,
                                   @RequestParam @NotNull String userPassword) throws Exception {
        // SetHeader
    ...
    public JSONObject loginUser(@NotNull HttpServletResponse response,
                                @RequestParam @NotNull String reCaptchaResponse,
                                @RequestParam @NotNull String userName,
                                @RequestParam @NotNull String userPassword) throws IOException, NoSuchAlgorithmException, InvalidKeySpecException, SignatureException, InvalidKeyException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, IllegalAccessException {
        // SetHeader
        response.setContentType("application/json;charset=UTF-8");
        response.setHeader("Access-Control-Allow-Origin", "*");
